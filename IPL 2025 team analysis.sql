...
--- Q4 Rank players by their price within each team and list top 2 for every team.
...
--- Q5 Find the most expensive player from each team, along with the most second-most expensive player's name and price
...
select team,
	...
	MAX(case when rankwithinteam = 2 then player else null end) as Secondexpensiveplayer,
...
--- Q7 Classify players as high, medium or low priced based on following rules:
-- High: Price > 15 cr
-- medium: price between 5cr and 15cr
-- low: Price < 5 cr and find out the players in each bracket
...
--- Q9 Identify players who can earn more than the average price in their team.
